...
<html>
<body style="background-color:#7da87b">
<div class="s">
<h1 align="center" id="h1">welcome to facebook
    ...
    echo "</i>";
    ?></h1>
    <a href='logout.php'><h3 style="color:crimson; float:right; width:150px"><button>logout</button></a>
...
echo "<center>";
echo '<p style="font-size:15px;color:#155363" align="center"> '.$row['c'].' posted</p>';
break;
}
$ga="   ";
...
echo '<form method="post" >';
echo  '<input type="hidden" name="path" value="'.$pat.'">';
echo '<input type="text" name="comment" placeholder="enter your comment" style=" height: 20px; width:150px">';
